			  ...
			  tabsetPanel(type = 'tabs',
				  ...
				  fluidRow(
				    ...
				    column(6, 
				           plotOutput('abl_tables_plot_ti', height='350px', 
				                      hover= hoverOpts("abl_tables_plot_ti_hov", delay = 100, delayType = "debounce")),
				           uiOutput("abl_tables_plot_ti_hinf"),
				...
				tabPanel('Items',
				  ...
				  fluidRow(
				    column(6,
				      tags$div(
				        tags$p(tags$b('Item fit')),
  				      enumericInput("enorm_slider_nbins","nbins",min=2,step=1,value=5,inline=TRUE,width='5em')),     
				      plotSlider('enorm_slider',height='600px',width='100%')),
				    column(6,
				      tags$p(tags$b('Item parameters')),
