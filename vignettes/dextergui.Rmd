...
The easiest way to familiarize yourself with dextergui is to open an example project, e.g. the verbal agression dataset, by clicking on _example datasets_ and then choose _verbal aggression_. This is a rich one booklet dataset with person and item properties and ideal for exploring the gui.
...
There is also a test for DIF at the item level.
